// client/src/lib/achievementsCatalog.ts
// Catálogo de conquistas usado pelo frontend para renderizar todas as badges.
// Mantém os mesmos IDs do backend (server/services/achievements.ts).
...
export function entityFromTipoUsuario(tipo: string): Entity | null {
  ...
  return null; // Admin/Olheiro ainda sem catálogo
}
