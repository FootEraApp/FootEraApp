...
async function hash(p) {
    return bcryptjs_1.default.hash(p, 10);
}
async function main() {
    var _a;
    const PASSWORDS = {
    ...
    const H = Object.fromEntries(await Promise.all(Object.entries(PASSWORDS).map(async ([k, v]) => [k, await hash(v)])));
    const clube1 = await prisma.usuario.upsert({
        ...
        create: {
            ...
            tipo: client_1.TipoUsuario.Clube,
            cidade: 'São Paulo',
            estado: 'SP',
            pais: 'Brasil',
    ...
    await prisma.usuario.upsert({
        ...
        create: {
            ...
            tipo: client_1.TipoUsuario.Escolinha,
            cidade: "São Paulo",
            estado: "SP",
            pais: "Brasil",
    ...
    await prisma.usuario.upsert({
        ...
        update: {
            tipo: client_1.TipoUsuario.Professor,
    ...
    const olheiroJoao = await prisma.usuario.upsert({
        ...
        create: {
            ...
            tipo: client_1.TipoUsuario.Olheiro,
            cidade: 'São Paulo',
            estado: 'SP',
            pais: 'Brasil',
    ...
    const atletaLucas = await prisma.usuario.upsert({
        ...
        create: {
            ...
            tipo: client_1.TipoUsuario.Atleta,
            cidade: "Vitória",
            estado: "ES",
            ...
            atleta: {
                create: {
                    ...
                    sobrenome: "Ferreira",
                    email: "lucas.ferreira@example.com",
                    clubeId: clube2Db === null || clube2Db === void 0 ? void 0 : clube2Db.id,
                    idade: 16,
                    cpf: "12345678900",
                    telefone1: "27999990000",
                    nacionalidade: "Brasileiro",
                    naturalidade: "Vitória - ES",
                    posicao: client_1.PosicaoCampo.MEI,
                    altura: 1.75,
                    peso: 65.0,
                    seloQualidade: "Prata",
                    categoria: [client_1.Categoria.Sub17],
                    foto: "/assets/usuarios/lucas.jpg"
                }
            }
        }
        ...
        create: {
            ...
            atleta: {
                create: {
                    ...
                    sobrenome: "Mendes",
                    email: "ana.mendes@example.com",
                    clubeId: clube1Db === null || clube1Db === void 0 ? void 0 : clube1Db.id,
                    idade: 15,
                    cpf: "98765432100",
                    telefone1: "27988880000",
                    nacionalidade: "Brasileira",
                    naturalidade: "Vila Velha - ES",
                    posicao: client_1.PosicaoCampo.CA,
                    altura: 1.65,
                    peso: 58.0,
                    seloQualidade: "Ouro",
                    categoria: [client_1.Categoria.Sub15],
                    foto: "/assets/usuarios/ana.webp"
                }
            }
        }
    ...
    if (professorMateus && ex1 && ex2 && ex3 && ex4 && ex5) {
        await prisma.treinoProgramado.upsert({
            ...
            create: {
                ...
                categoria: [client_1.Categoria.Livre],
                duracao: 60,
                tipoTreino: client_1.TipoTreino.Tecnico,
    ...
    if (professorMateus &&
        ...
        await prisma.treinoProgramado.upsert({
            where: { codigo: 'TR003' },
            update: {
                tipoTreino: client_1.TipoTreino.Fisico,
                dataAgendada: prazo25Out,
                exercicios: {
                    deleteMany: {},
                    create: [
    ...
    if (atletaFormado && escolinhaEstrelasDb) {
        const jaTem = await prisma.vinculoFormacao.findFirst({
            where: {
                ...
                origem: client_1.OrigemFormador.Escolinha,
        ...
        create: {
            ...
            atleta: {
                create: {
                    ...
                    sobrenome: "",
                    idade: 16,
                    posicao: client_1.PosicaoCampo.ZD,
                    altura: 1.8,
                    peso: 72,
                    nacionalidade: "Brasileira",
        ...
        create: {
            ...
            atleta: {
                create: {
                    ...
                    sobrenome: "",
                    idade: 16,
                    posicao: client_1.PosicaoCampo.ZE,
                    altura: 1.8,
                    peso: 72,
                    nacionalidade: "Brasileira",
                    naturalidade: "Vitória - ES",
    ...
    async function garantirAssinaturaFixa(usuarioId, plano, periodicidade) {
        ...
        const jaTemPagamento = await prisma.pagamento.findFirst({
            where: {
                usuarioId,
                plano,
                status: client_1.PagamentoStatus.APROVADO,
            },
        });
        if (!jaTemPagamento) {
    ...
    if (usuarioAtletaPro) {
        await garantirAssinaturaFixa(usuarioAtletaPro.id, 'ATLETA_PRO', client_1.Periodicidade.Mensal);
    }
    if (usuarioProfPro) {
        await garantirAssinaturaFixa(usuarioProfPro.id, 'PROFESSOR_PRO', client_1.Periodicidade.Mensal);
    }
    if (usuarioScoutPro) {
        await garantirAssinaturaFixa(usuarioScoutPro.id, 'OLHEIRO_PRO', client_1.Periodicidade.Mensal);
    }
    if (usuarioEscolinha01Db) {
        await garantirAssinaturaFixa(usuarioEscolinha01Db.id, 'ESCOLINHA_PRO', client_1.Periodicidade.Mensal);
    }
    ...
    if (atletaFree && atletaPro) {
        ...
        await prisma.curtida.createMany({
            data: [
                ...
                {
                    postagemId: post2.id,
                    usuarioId: (_a = atletaTeste === null || atletaTeste === void 0 ? void 0 : atletaTeste.usuarioId) !== null && _a !== void 0 ? _a : atletaFree.id,
                    createdAt: daysAgo(3),
                },
            ],
        });
        ...
        if (!msgInicial) {
            await prisma.mensagem.create({
                data: {
                    ...
                    paraId: atletaPro.id,
                    conteudo: 'Mensagem inicial seed E2E',
                    tipo: client_1.TipoMensagem.NORMAL,
                },
            });
        }
    }
